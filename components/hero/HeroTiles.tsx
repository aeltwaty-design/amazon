...
// Design-specified tile washes: purple 50, yellow 50, purple 50, then the
// benefit-card tones. Independent of the Benefits cards' tones.
const TONE_CLASS = ['card-tone-1', 'card-tone-2', 'card-tone-1', 'card-tone-4', 'card-tone-5'];
