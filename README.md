...
- The phone on the first Benefits card: its box is centred on the card (0 px off) with its bottom on the card's bottom edge, 64 % of the card wide on desktop (222 px at 1440 × 900, 202 px at 1024 × 760) and 198 px on a 354 px stacked card, its height the asset's 1140 / 848 of that (the top two thirds of the phone); the body copy ends 200 px above it at 1440 × 900; the mirror card and its phone box equal their grid twins; the request is answered 200 as AVIF; alt text present in both locales; the stacked card is 460 px; the pin's hand-over, landing and zero layout shift are unchanged.
