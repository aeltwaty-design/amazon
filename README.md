...
- The phones on the three Benefits cards: each box is centred on its card (0 px off) with its bottom on the card's bottom edge; on desktop the box is 56 % of the card's height and 72 % of its width and the phone fits it bottom-centred, so it draws 239 × 362 px at 1440 × 900 and 188 × 284 px at 1024 × 760 (limited by height), and 198 × 300 px on a 354 × 500 px stacked card; the body copy ends at least 137 px above the phone at 1440 × 900 and 52 px above it at 1024 × 760 (the English first card is the tightest); each mirror card and its phone box equal their grid twins; the `next/image` requests are answered 200 as AVIF; alt text present in both locales; the stacked cards are 500 px; the pin's hand-over, landing and zero layout shift are unchanged.
